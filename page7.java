...
public class page7 extends Activity implements OnCheckedChangeListener {
	Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page7);
         ...
         btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               Toast.makeText(page7.this,passtypebutton.getText(),Toast.LENGTH_SHORT).show();
			   ...
			   try
				{
					...
					String url="http://10.100.9.232/lcv.php?name="
	 ...
	 private class pass_value_to_db extends AsyncTask<String, Void, String>{
			...
			protected void onPreExecute() { //  TODO Auto-generated method stub
				dialog = new ProgressDialog(page7.this);
