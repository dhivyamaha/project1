...
public class page6 extends Activity implements OnCheckedChangeListener {
	...
	String uname1, vehnum1, passtype1, amount1,type1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(page6.this, passtypebutton.getText(),
				...
				try {
					...
					String url = "http://10.100.9.232/bus.php?name="
							+ uname1.trim() + "&vehicleno=" + vehnum1.trim()
							+ "&passtype=" + passtype1.trim() + "&amount="
							+ amount1.trim();
	...
	private class pass_value_to_db extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("false")) {
				...
				Intent i = new Intent(getApplicationContext(), page10.class);
				i.putExtra("amount", a);
